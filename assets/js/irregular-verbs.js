/*!
 * Renan le Professeur — Verbes Irréguliers du Français (irregular-verbs.html)
 ...
 * (infinitive, meaning, présent/je, passé composé, irregularity type)
...
(function () {
  ...
  function filter() {
    ...
    if (countNotice) {
      ...
      var text = q
        ? "Affichage de " + shown + " sur " + total + " verbes correspondant à “" + input.value.trim() + "”."
        : "Affichage des " + total + " verbes. Cherche par infinitif, sens ou n'importe quelle forme conjuguée.";
