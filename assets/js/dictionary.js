/*!
 * Renan le Professeur — Recherche de mots dans le dictionnaire (cours de français)
...
(function () {
  ...
  function update() {
    ...
    cards.forEach(function (card) {
      ...
      link.appendChild(document.createTextNode(raw ? "Chercher “" + raw + "”" : "Chercher"));
    });
  }
